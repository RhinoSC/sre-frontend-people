...
const handlerPaypalDonation = async () => {
  ...
  btn.value = (window as any).PayPal.Donation.Button({
    ...
    item_name: `Fundación Save One Animal`,
    image_url: `https://media.discordapp.net/attachments/701204143678685205/1286824900643782779/Logo_Blanco.png?ex=66ef5094&is=66edff14&hm=f00746cb058169ef6abaf7a39ab851195b67328164780e23c913ca06f080771a&=&format=webp&quality=lossless`,
