  ...
  <div class="flex flex-col items-center justify-center gap-6 p-6 capitalize">
    <div>
      <div class="flex flex-col items-center justify-center gap-6">
        <h1 class="text-4xl font-bold text-center text-indigo-500">{{ t("donations") }}</h1>
        <p class="text-xl">{{ t("total") }} {{ t("donations") }}: {{ donations?.length }}</p>
      </div>
    </div>
    <div class="flex flex-col items-center justify-center gap-6">
      <input v-model="searchQuery" type="text" :placeholder="t('next') + '...'"
